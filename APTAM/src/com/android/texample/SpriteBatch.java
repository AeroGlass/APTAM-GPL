...
public class SpriteBatch {
   ...
   // A: [none]
   // R: [none]
   public void endBatch(int shaderid)  {
   ...
   // R: [none]
   public void drawSprite(float x, float y, float width, float height, TextureRegion region, int shaderid)  {
      if ( numSprites == maxSprites )  {              // IF Sprite Buffer is Full
         endBatch(shaderid);                                  // End Batch
